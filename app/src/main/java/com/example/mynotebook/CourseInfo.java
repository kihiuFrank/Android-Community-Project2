...
public final class CourseInfo implements Parcelable {
    ...
    private final List<com.example.mynotebook.ModuleInfo> mModules;

    public CourseInfo(String courseId, String title, List<com.example.mynotebook.ModuleInfo> modules) {
        mCourseId = courseId;
        mTitle = title;
        mModules = modules;
    }
    ...
    private CourseInfo(Parcel source) {
        ...
        source.readTypedList(mModules, com.example.mynotebook.ModuleInfo.CREATOR);
    }
    ...
    public List<com.example.mynotebook.ModuleInfo> getModules() {
        return mModules;
    }
